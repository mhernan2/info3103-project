...
app.config['SESSION_COOKIE_NAME'] = 'alpha'
...
class Login(Resource):
	...
	# curl -i -H "Content-Type: application/json" -X POST -d '{"username": "Casper", "password": "crap"}' -c cookie-jar -k https://info3103.cs.unb.ca:36371/signin
	#
	def post(self):
	...
	#
	# Example curl command:
	# curl -i -H "Content-Type: application/json" -X GET -b cookie-jar -k https://info3103.cs.unb.ca:36371/signin
	def get(self):
		success = False
